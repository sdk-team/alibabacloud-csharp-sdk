...
namespace AlibabaCloud.SDK.Vpc20160428
{
    public class Client : AlibabaCloud.RPCClient.Client
    {
        ...
        public ListPhysicalConnectionFeaturesResponse ListPhysicalConnectionFeaturesWithOptions(ListPhysicalConnectionFeaturesRequest request, AlibabaCloud.TeaUtil.Models.RuntimeOptions runtime)
        {
            ...
            return TeaModel.ToObject<ListPhysicalConnectionFeaturesResponse>(DoRequest("ListPhysicalConnectionFeatures", "HTTPS", "POST", "2016-04-28", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<ListPhysicalConnectionFeaturesResponse>(await DoRequestAsync("ListPhysicalConnectionFeatures", "HTTPS", "POST", "2016-04-28", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<GetNatGatewayConvertStatusResponse>(DoRequest("GetNatGatewayConvertStatus", "HTTPS", "POST", "2016-04-28", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<GetNatGatewayConvertStatusResponse>(await DoRequestAsync("GetNatGatewayConvertStatus", "HTTPS", "POST", "2016-04-28", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<UpdateNatGatewayNatTypeResponse>(DoRequest("UpdateNatGatewayNatType", "HTTPS", "POST", "2016-04-28", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<UpdateNatGatewayNatTypeResponse>(await DoRequestAsync("UpdateNatGatewayNatType", "HTTPS", "POST", "2016-04-28", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<ListEnhanhcedNatGatewayAvailableZonesResponse>(DoRequest("ListEnhanhcedNatGatewayAvailableZones", "HTTPS", "POST", "2016-04-28", "AK", null, request.ToMap(), runtime));
        }
        ...
        {
            AlibabaCloud.TeaUtil.Common.ValidateModel(request);
            return TeaModel.ToObject<ListEnhanhcedNatGatewayAvailableZonesResponse>(await DoRequestAsync("ListEnhanhcedNatGatewayAvailableZones", "HTTPS", "POST", "2016-04-28", "AK", null, request.ToMap(), runtime));
        }
